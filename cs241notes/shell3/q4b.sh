...
awk '{if($1=="School3"){count++; if(count%2==0){ans+=$2} } } END {print "School1: "ans/5.0} ' school_database.txt
awk '{if($1=="School4"){count++; if(count%2==0){ans+=$2} } } END {print "School1: "ans/5.0} ' school_database.txt